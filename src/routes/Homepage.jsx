...
<div className='flex justify-between items-center'>
      <div>
        <h1 className='text-2xl md:text-5xl lg:text-6xl font-bold text-gray-800'>Lorem ipsum dolor sit amet  adipisicing elit. </h1>
        <p className='mt-8 text-md md:text-xl'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. </p>
      </div>
